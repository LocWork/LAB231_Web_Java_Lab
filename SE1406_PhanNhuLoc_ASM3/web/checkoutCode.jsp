<%-- 
    Document   : checkoutCode
    Created on : Nov 2, 2020, 8:22:59 AM
    Author     : hi
--%>
...
<html>
    <head>
        ...
        <title>Check Out Code Page</title>
         <style>
            html {
                margin: auto;
                overflow: scroll;
    ...
    <body>
        ...
        <c:if test="${sessionScope.CHECKOUT_CODE == null}">
            <c:redirect url="home.jsp"/>
        </c:if>
        <div class="menu">
        ...
        <div class="resetContainer">
            <div class="resetBox">
                ...
                <div class="resetForm">                    
                    <form action="CheckoutValidate" method="POST">
