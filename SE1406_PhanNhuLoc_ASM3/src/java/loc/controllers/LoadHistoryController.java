...
public class LoadHistoryController extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(LoadHistoryController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookingDTO> list = extra.getBookList(user.getUserID());
            request.setAttribute("LIST", list);
            url = SUCCESS;
        } catch (Exception e) {
            LOGGER.error("Error at LoadHistoryController: " + e.toString());
        } finally {
