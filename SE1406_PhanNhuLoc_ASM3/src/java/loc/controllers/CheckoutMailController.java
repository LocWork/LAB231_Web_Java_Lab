 ...
 * @author hi
 */
public class CheckoutMailController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "checkoutCode.jsp";
    private static final String FAIL = "viewCart.jsp";
    private static final Logger LOGGER = Logger.getLogger(CheckoutMailController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String subject = "Booked code email";
            String msg = "";
            ...
            if (valid == true) {
                ...
                session.setAttribute("CHECKOUT_CODE", code);
            ...
            LOGGER.error("Error at CheckoutMailController: " + e.toString());
        } finally {
