...
public class HotelRoomController extends HttpServlet {
    ...
    private static final String SUCCESS = "room.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<RoomDTO> list = dao.getRoomList(hotelID, checkInDate, checkOutDate);
            request.setAttribute("ROOM_LIST", list);
            url = SUCCESS;

        } catch (Exception e) {
            LOGGER.error("Error at HotelRoomController: " + e.toString());
        } finally {
