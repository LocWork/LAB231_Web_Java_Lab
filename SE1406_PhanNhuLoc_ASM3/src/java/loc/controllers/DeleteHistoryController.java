...
public class DeleteHistoryController extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(DeleteHistoryController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (extraDAO.updateBooking(bookingID)) {
                url = SUCCESS;
            }
        } catch (Exception e) {
            LOGGER.error("Error at DeleteHistoryController: " + e.toString());
        } finally {
